    ...
    func observeLoadedChats(userIdentifier: String,
        ...
        chats.forEach { chat in
            if chat.isGroup {
                ...
                FirebaseUserStatusService.fetchUserStatus(userIdentifier: companion.identifier) { isOnline in
                ...
                let userStatusObserver = FirebaseUserStatusService.observeUserStatus(

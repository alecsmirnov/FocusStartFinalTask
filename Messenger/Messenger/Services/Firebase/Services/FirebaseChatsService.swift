...
extension FirebaseChatsService {
    static func observeLatestMessagesChanged(chatIdentifier: String,
    ...
    static func observeUnreadMessagesChanged(chatIdentifier: String,
                                             userIdentifier: String,
    ...
    static func observeAddedChats(for userIdentifier: String,
...
extension FirebaseChatsService {
    static func fetchPairChat(chatIdentifier: String,
                              userIdentifier: String,
        ...
        fetchChatCompanionIdentifier(chatIdentifier: chatIdentifier,
            ...
            FirebaseUserService.fetchUser(userIdentifier: companionIdentifier) { companion in
                ...
                fetchUserChatLatestMessage(chatIdentifier: chatIdentifier,
                                           userIdentifier: userIdentifier) { latestMessage in
                    fetchChatUnreadMessagesCount(chatIdentifier: chatIdentifier,
    ...
    static func fetchChatCompanionIdentifier(chatIdentifier: String,
                                             userIdentifier: String,
    ...
    static func fetchUserChatLatestMessage(chatIdentifier: String,
                                           userIdentifier: String,
    ...
    static func fetchUserChatLatestMessageWithUpdateTime(chatIdentifier: String,
                                                         userIdentifier: String,
                                                         latestUpdateTime: TimeInterval,
                                                         completion: @escaping (MessageInfo?) -> Void) {
        databaseReference.child(Tables.usersChatsLatestMessages)
    ...
    static func fetchChatLatestMessageIdentifier(chatIdentifier: String,
                                                 userIdentifier: String,
                                                 completion: @escaping (String?) -> Void) {
        databaseReference.child(Tables.usersChatsLatestMessages)
                         .child(userIdentifier)
    ...
    static func fetchChatUnreadMessagesCount(chatIdentifier: String,
                                             userIdentifier: String,
    ...
    static func fetchChatUnreadMessagesCountWithUpdateTime(chatIdentifier: String,
                                                           userIdentifier: String,
                                                           latestUpdateTime: TimeInterval,
                                                           completion: @escaping (Int?) -> Void) {
        databaseReference.child(Tables.usersChatsUnread)
